    ...
    <>
      ...
      >
        <div className="w-full flex justify-between items-center max-w-7xl mx-auto animate-[slidedown_2s_cubic-bezier(.19,1,.22,1)_forwards]">
          ...
          <div className="flex h-min gap-2 items-center w-max ">
            ...
            <div
              className={
                activeItem === "work"
                  ? "w-full  flex gap-2 items-center rounded-2xl   font-light shadow-lg cursor-pointer   text-sx"
                  : activeItem === "home"
                  ? "w-full  flex gap-2 items-center rounded-2xl   font-light shadow-lg cursor-pointe text-sx"
                  : "w-full  flex gap-2 items-center rounded-2xl   font-light shadow-lg cursor-pointer    text-sx"
              }
            >
              <Link to="/home">
