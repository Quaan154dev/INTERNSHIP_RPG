...
//       />
//       <div
//         className={`absolute top-[10%] left-1/2 transform -translate-x-1/2 ${messageOpacity} transition-opacity duration-2000`}
//       >
//         Hạnh phúc
//       </div>
//       <div
//         className={`absolute bottom-[50%] left-1/2 bg-white p-2.5 rounded-lg shadow-lg transition-all duration-2000 ${chatBoxOpacity}`}
//       >
//         Chào bạn!
//       </div>
//       <div
//         className={`absolute bottom-[50%] right-[35%] bg-white p-2.5 rounded-lg shadow-lg transition-all duration-2000 ${chatBox2Opacity}`}
//       >
//         Chào bạn 2!
//       </div>
//     </div>
...
import gameImage from "../../assets/sadstory/boy.png"; // hiện hình game
